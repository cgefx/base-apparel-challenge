		...
		<div className='container'>
			<div className='text-box'>
				...
				<div className='text-box__inner'>
					<h1 className='text-box__headline'>
						<span className='text-box__headline--accent'>We're </span> coming soon
					</h1>
					<p className='text-box__paragraph'>
					...
					<div className='text-box__form'>
						<form action='' className='form'>
							...
							<div className='form__input--alert-text'>Please provide a valid email</div>
						</form>
					</div>
				</div>
			</div>
